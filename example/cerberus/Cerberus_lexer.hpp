...
constexpr cerb::gl::Map<CerberusLexerItem, yytokentype, 67> CerberusLexerItemsNamesConverter{
    true, {
    {CerberusLexerItem::UNDEFINED           , yytokentype::UNDEFINED},
    {CerberusLexerItem::EoF                 , yytokentype::EoF},
    {CerberusLexerItem::SELF                , yytokentype::SELF},
    {CerberusLexerItem::EXPR                , yytokentype::EXPR},
    {CerberusLexerItem::TERM                , yytokentype::TERM},
    {CerberusLexerItem::EMPTY               , yytokentype::EMPTY},
    ...
    {CerberusLexerItem::INT_T               , yytokentype::INT_T},
    {CerberusLexerItem::CHAR_T              , yytokentype::CHAR_T},
    {CerberusLexerItem::FLOAT_T             , yytokentype::FLOAT_T},
    {CerberusLexerItem::DOUBLE_T            , yytokentype::DOUBLE_T},
    {CerberusLexerItem::BUILTIN_AUTO_T      , yytokentype::BUILTIN_AUTO_T},
...
inline cerb::Map<CerberusLexerItem, cerb::string_view> CerberusLexerItemItemsNames(
    {
        ...
        { CerberusLexerItem::SELF, "SELF"_sv },
        { CerberusLexerItem::EXPR, "EXPR"_sv },
        { CerberusLexerItem::TERM, "TERM"_sv },
        { CerberusLexerItem::EMPTY, "EMPTY"_sv },
