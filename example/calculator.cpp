...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ADD = 3,                        /* ADD  */
  YYSYMBOL_INTEGERAL = 4,                  /* INTEGERAL  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ADD", "INTEGERAL",
...
#line 1096 "calculator.cpp"
    break;

  case 4: /* expr: INTEGERAL  */
#line 20 "calculator.y"
                                        { yyval = yyvsp[0]; }
#line 1102 "calculator.cpp"
    break;

  case 5: /* expr: expr ADD expr  */
#line 21 "calculator.y"
                                        { yyval = std::to_string(std::atoi(yyvsp[-2].c_str()) + std::atoi(yyvsp[0].c_str())); }
#line 1108 "calculator.cpp"
    break;


#line 1112 "calculator.cpp"
